...
class AgentVerificationInput(BaseModel):
    ...
    min_score: float = Field(default=60.0, description="Minimum trust score required (0-100)")
        ...
        for agent_id in agent_list:
            ...
            try:
                ...
                if trust_score >= min_score:
                    ...
                    results.append(f"❌ {agent_name}: {trust_score:.1f}/100 ({trust_tier}) - FAILED (min: {min_score})")
                    all_passed = False
