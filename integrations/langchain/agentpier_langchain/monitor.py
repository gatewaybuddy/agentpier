...
class ChainMonitor:
    ...
    def verify_agent_trust(
        self, agent_id: str, min_score: float = 60.0
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                ...
                "reason": (
                    ...
                    else f"Score {trust_score:.1f} below minimum {min_score}"
                ),
            }
    ...
    def verify_multiple_agents(
        self, agent_ids: List[str], min_score: float = 60.0
    ) -> Dict[str, Any]:
        """
        ...
        for agent_id in agent_ids:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    agent_data.append(
                        {"agent_id": agent_id, "found": False, "trust_score": None}
                    )
