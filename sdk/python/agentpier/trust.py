...
class TrustMethods:
    ...
    def register_agent(self, agent_name: str, description: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def get_score(self, agent_id: str) -> AgentTrustScore:
        ...
        if response.get("registered_at"):
            registered_at = datetime.fromisoformat(response["registered_at"].replace('Z', '+00:00'))
