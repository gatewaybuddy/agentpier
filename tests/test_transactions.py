...
def sample_listing(dynamodb, sample_user):
    ...
    listing = {
        ...
        "description": "24/7 automated workflow and monitoring services",
        "posted_by": user_id,
        "agent_name": "testbot",
        "status": "active",
        "created_at": now,
...
class TestCreateTransaction:
    ...
    def test_missing_listing_id(self, dynamodb, second_user):
        ...
        event = make_api_event(
            method="POST", api_key=consumer_key, body={"amount": 100}
        )
    ...
    def test_nonexistent_listing(self, dynamodb, second_user):
        ...
        event = make_api_event(
            method="POST", api_key=consumer_key, body={"listing_id": "lst_nonexistent"}
        )
    ...
    def test_self_transaction(self, dynamodb, sample_listing, sample_user):
        ...
        event = make_api_event(
            method="POST", api_key=provider_key, body={"listing_id": listing_id}
        )
    ...
    def test_unauthenticated(self, dynamodb):
        ...
        event = make_api_event(method="POST", body={"listing_id": "lst_test"})
...
class TestGetTransaction:
    def test_success_provider(self, dynamodb, sample_transaction, sample_user):
        ...
        event = make_api_event(api_key=provider_key, path_params={"id": transaction_id})
    ...
    def test_success_consumer(self, dynamodb, sample_transaction, second_user):
        ...
        event = make_api_event(api_key=consumer_key, path_params={"id": transaction_id})
    ...
    def test_forbidden_third_party(self, dynamodb, sample_transaction):
        ...
        event = make_api_event(api_key=third_key, path_params={"id": transaction_id})
    ...
    def test_nonexistent(self, dynamodb, sample_user):
        ...
        event = make_api_event(api_key=user_key, path_params={"id": "txn_nonexistent"})
...
class TestListTransactions:
    def test_success(self, dynamodb, sample_transaction, sample_user):
        ...
        event = make_api_event(api_key=provider_key, query_params={"role": "provider"})
    ...
    def test_status_filter(self, dynamodb, sample_transaction, sample_user):
        ...
        event = make_api_event(api_key=user_key, query_params={"status": "pending"})
    ...
    def test_invalid_role(self, dynamodb, sample_user):
        ...
        event = make_api_event(api_key=user_key, query_params={"role": "invalid"})
...
class TestCreateReview:
    def test_success(self, dynamodb, sample_transaction, sample_user, second_user):
        ...
        event = make_api_event(
            ...
            api_key=consumer_key,
            path_params={"id": transaction_id},
            body={"rating": 5, "comment": "Excellent service, very professional"},
        )
    ...
    def test_duplicate_review(
        self, dynamodb, sample_transaction, sample_user, second_user
    ):
        from handlers.transactions import update_transaction, create_review
