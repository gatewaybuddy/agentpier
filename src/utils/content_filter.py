...
try:
    ...
    from utils.content_filter_patterns import (
        BLOCKED_CATEGORIES,
        _DANGEROUS_SUBSTRINGS as _PRIVATE_DANGEROUS,
    )
except ImportError:
...
def log_content_violation(
    user_id: str, listing_data: dict, categories: list[str], client_ip: str = "unknown"
):
